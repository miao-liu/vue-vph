<template>
    <div class="add-address">
        ...
        <div>设置为默认收货地址 <span class="default" @click="setDefault()"></span></div>
...
export default {
  ...
  methods: {
    ...
    saveaddr () {
      ...
      const data = { username: window.sessionStorage.getItem('username'), name: this.user, phone: this.phone, address: this.address, default: this.is_default }
